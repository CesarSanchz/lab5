...
function getRandomImage(keyword, count) {
    return new Promise (function (resolve, reject) {
        let requestUrl = `https://api.unsplash.com/photos/random/?count=${count}&client_id=856NVPR5CLQRcdu9DG0TbjaYeD69-fWv2h299HNKYRE&featured=true&orientation=landscape&query=${keyword}`;
